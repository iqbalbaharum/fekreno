<template>
  <q-page>
    ...
    <div class="q-pa-md row justify-end">
      <q-btn @click="onClickAddMaterial" color="primary" icon="fas fa-plus" label="Material" />
    </div>
      ...
      <div class="col">
        <q-list separator flat>
          <q-scroll-area style="height: 100vh;">
            <q-item v-for="(material) in materials" :key="material.id" class="q-pa-md">
              ...
              <q-item-section>
                <q-item-label lines="1">
                  <span class="text-weight-bold">{{ material.user.name }}</span> shared <span class="text-weight-bold text-capitalize">{{ material.type }}</span>
                  <span class="text-caption q-ml-md">{{ timeDifference(material.createdAt) }}</span>
                </q-item-label>
                <q-item-label caption lines="2">
                  <q-card bordered class="rounded-borders">
                    ...
                    <q-card-section bottom class="text-caption q-gutter-x-sm">
                      ...
                      /> 
                          <span class="text-capitalize">{{ material.reviewStatus }}</span>
                    </q-card-section>

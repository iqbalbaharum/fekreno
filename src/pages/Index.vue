    ...
    <div class="full-width row wrap justify-center items-start content-start q-gutter-md">
      <div class="col-10">
        <q-card class="q-pt-md">
          ...
          <q-tabs v-model="tab" class="bg-blue-grey-1" active-color="black" indicator-color="black" align="left">
    ...
    <q-dialog v-model="dialog.show" position="bottom">
      <q-card style="width: 800px">
        <q-item-section class="q-pa-md bg-primary text-white">
          <q-item-label
            >Update <strong>{{ name }}</strong> Profile</q-item-label
          >
        </q-item-section>
        ...
        <q-card-section class="row q-gutter-sm justify-center">
          ...
          <q-input filled v-model="form.fullname" label="Full Name" class="col-12" />

          <q-input filled v-model="form.about" label="About" hint="Tell us anything about you" type="textarea" class="col-12" :rules="[(val) => val.length <= 200 || 'Please use maximum 200 characters']" />
          ...
          <q-input filled v-model="fixed.email" label="E-mail" disable class="col-12" />

          <q-input filled v-model="fixed.mobile" disable label="Mobile" class="col-12" hint="To change mobile number, please emailed mailing@krenovator.cc" />

          <q-input filled v-model="form.github" label="Github" hint="Register and account https://www.github.com" class="col-12" />

          <q-input filled v-model="form.linkedin" label="LinkedIn" hint="Register and account https://www.linkedin.com" class="col-12" />
        </q-card-section>

            ...
            <q-card-section horizontal>
              <q-item-section>
                <q-avatar size="100px" color="accent" square>
                  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTyGo8XzszXwJThST5wxfqGFehUkRrVS6Njdw&usqp=CAU" />
                </q-avatar>
              </q-item-section>
              <q-card-section>
...
export default {
  ...
  computed: {
    ...
    userprofile() {
      let profile = UserProfile.query().withAll().where("userId", this.userId).first();
      return profile;
    },
  },
